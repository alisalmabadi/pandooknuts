(function ($) {
    ...
    uza_window.on('load', function () {
        if (window.location.pathname == '/') {
            if ($(document).width() < 992) $('.menuText').removeClass('white');
        }else{
            $('.menuText').removeClass('white');
            $('.main-header-area').addClass('sticky');
            $('.main-header-area').removeClass('gradient');
        }
    ...
    uza_window.on('scroll', function () {
            ...
            if (window.location.pathname == '/') {
                if (uza_window.scrollTop() > 0) {
                    ...
                    $('.main-header-area').addClass('gradient');

                    if ($(document).width() > 992) $('.menuText').addClass('white');
