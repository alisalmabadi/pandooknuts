...
<html>
<head>
  <title>ویرایش دانشنامه | پندوک</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li >دانشنامه</li>
        <li class="active">ویرایش دانشنامه</li>
      </ol>
    </section>
    <form action="{{route('wiki.update',['id'=>$wiki->id])}}" method="post" enctype="multipart/form-data">
    {{csrf_field()}}
    {{method_field('put')}}
    <!-- Main content -->
              ...
              <div class="box-body no-padding">
                <select name="categories" id="" class="form-control">
                  ...
                  @foreach($categories as $category)
                    <option value="cat{{$category->id}}" @if($wiki->cat_id==$category->id) selected @endif>{{$category->name}}</option>
                  @endforeach
                </select>
              ...
              <div class="box-body no-padding">
                <div class="input-group" style="width: 100%;padding: 10px">
                  <div id="picture" style="width: 100%;margin: 5px auto;">
                    ...
                    <img style="width: 50%" src="{{$wiki->image}}" />
                  </div>
                  ...
                  <input  type="text" hidden name="mainImage" value="{{$wiki->image}}" style="width: 100%;height: 100%" id="featured_image" placeholder="آدرس تصویر" readonly  />
              ...
              <div class="box-footer">
                <div class="pull-right">
                  <label for="featured" type="button" class="btn btn-default"><i class="fa fa-home"></i>
                    <input name="featured" id="featured" type="checkbox" @if($wiki->featured==1) checked @endif/>
                    <label for="featured" class="label-info"></label>

                    نمایش در صفحه اصلی</label>
                  <button type="submit" class="btn btn-primary" onclick="return blogvalidate()"><i class="fa fa-share"></i> ویرایش</button>
                </div>
              </div>
            </div>
            <!-- /.box-footer -->
