...
<html>
<head>
  <title> تنظیمات قالب | پندوک</title>
            ...
            <div class="box-body no-padding">
              <form role="form" action="{{route('template.update',['size'=>$selectedTemplate->id])}}" method="POST">
                ...
                <div class="box-body">
                  ...
                  @endif
                  @if($selectedTemplate->place=='video')
                    ...
                    <div class="input-group" style="width: 100%;padding: 10px">
                      ...
                      <input  type="text" value="{{$selectedTemplate->video}}" style="direction: ltr;text-align: left;font-family: Arial!important;" name="mainVideo" style="width: 100%;height: 100%" id="featured_video" placeholder="آدرس فیلم" readonly  />
