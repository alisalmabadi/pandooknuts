...
<html>
<head>
  <title>افزودن محصولات | پندوک</title>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="form-group">
                    <input class="form-control" name="name" id="name" placeholder="نام محصول">
                </div>
                </div>
            ...
            <div class="box-body">
              <div class="form-group">
                  <div class="form-group">
                      <input class="form-control" type="number" name="price" id="price" placeholder="قیمت محصول">
                  </div>
              </div>
