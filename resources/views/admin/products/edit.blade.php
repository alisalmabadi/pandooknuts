...
<html>
<head>
  <title>ویرایش محصول | پندوک</title>
                ...
                <div class="box-body no-padding">
                  <select name="categories" id="" class="form-control">
                    ...
                    @foreach($categories as $category)
                      <option value="cat{{$category->id}}" @if($product->cat_id==$category->id) selected @endif>{{$category->name}}</option>
                    @endforeach
                  </select>
              ...
              <div class="box-header with-border">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <input class="form-control" name="name" id="name" value="{{$product->name}}" placeholder="نام محصول">
                  </div>
                </div>
                <h3 class="box-title"> قیمت به تومان</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                <div class="form-group">
                  <div class="form-group">
                    <input class="form-control" type="number" name="price" id="price" value="{{$product->price}}" placeholder="قیمت محصول">
                  </div>
                </div>
