            ...
            <div class="box-body no-padding">
              <div class="input-group" style="width: 100%;padding: 10px">
                <div id="picture" style="width: 100%;margin: 5px auto;">
                    ...
                    <img style="width: 50%" src="/img/sample.jpg" />
                </div>
                ...
                <input  type="text" hidden name="mainImage" style="width: 100%;height: 100%" id="featured_image" value="/img/sample.jpg" placeholder="آدرس تصویر" readonly  />
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="form-group">
                    <input class="form-control" name="title" id="title" placeholder="عنوان خبر">
                </div>
                </div>
