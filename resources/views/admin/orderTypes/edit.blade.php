...
<html>
<head>
  <title>ویرایش نوع سفارش | پندوک</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li >نوع سفارش</li>
        <li class="active">ویرایش نوع سفارش</li>
      </ol>
    </section>
<form action="{{route('orderType.update',$orderType)}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
@method('PATCH')
<!-- Main content -->
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="form-group col-md-8">
                    <input class="form-control" name="title" id="name" placeholder="نام نوع محصول" value="{{$orderType->title}}">
                </div>

                    <div class="form-group col-md-4">
                        <div class="form-group">
                            <select class="form-control" name="status">
                                <option value="0" @if(!$orderType->status) selected @endif >غیرفعال</option>
                                <option value="1" @if($orderType->status) selected @endif >فعال</option>
                            </select>
                        </div>
                    </div>
          ...
          <div class="box box-primary">
            <div class="box-footer">
              <div class="pull-right">
                <button type="submit" class="btn btn-primary"><i class="fa fa-share"></i> ویرایش</button>
              </div>
            </div>
          </div>
            <!-- /.box-footer -->
